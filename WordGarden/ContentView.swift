...
//  WordGarden
//
//  Created by GARCIA-MARTINEZ, DAVID on 1/13/26.
//
...
struct ContentView: View {
            ...
            if playAgainHidden {
                ...
                Button(playAgainButtonLabel) {
                    ...
                    if currentWordIndex == wordsToGuess.count {
                        ...
                        wordsGuessed = 0
                        wordsMissed = 0
                        playAgainButtonLabel = "AnotherWord?"
                    }
    ...
    func updateGamePlay() {
        if !wordToGuess.contains(guessedLetter) {
            guessesRemaining -= 1
            // Animate curmbling leaf and play the incorrect sound
        ...
        if !revealedWord.contains("_") { // Guessed when no "_" in revealedWord
            ...
            gameStatusMessage = "You've Made \(lettersGuessed.count) Guesses \(lettersGuessed.count == 1 ? "" : "es")"
        }
